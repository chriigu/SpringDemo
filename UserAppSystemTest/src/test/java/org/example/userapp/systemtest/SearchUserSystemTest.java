...
class SearchUserSystemTest {
    ...
    private static Stream<Arguments> userSearchArgs() {
        return Stream.of(
                Arguments.of(null, null, null, null, null, null, 1, 6, null, 0,1,0),
                Arguments.of(null, null, null, null, null, null, 0, 0, null, 0,0,0),
                Arguments.of(null, null, null, null, null, null, 0, 0, null, 0,0,0),
                Arguments.of(null, null, null, null, null, null, 0, 0, null, 0,0,0),
                Arguments.of(null, null, null, null, null, null, 0, 0, null, 0,0,0),
                Arguments.of(null, null, null, null, null, null, 0, 0, null, 0,0,0),
    ...
    void shouldSearchUsers(String firstName, String lastName, String email, LocalDate birthdate,
                           String order, String orderDirection, int page, int limit,
        ...
        given()
                ...
                .body("resultList[*].uuid", Matchers.notNullValue())
                .body("resultList[*].uuid", Matchers.hasLength(36))
                .body("resultList[*].uuid", expectedUuid != null ? Matchers.equalTo(expectedUuid) : Matchers.notNullValue())
                .body("resultList[*].firstName", firstName != null ? Matchers.contains(firstName) : Matchers.notNullValue())
                .body("resultList[*].lastName", lastName != null ? Matchers.contains(lastName) : Matchers.notNullValue())
                .body("resultList[*].email", email != null ? Matchers.contains(email) : Matchers.notNullValue())
                .body("resultList[*].birthdate", birthdate != null ? Matchers.equalTo(birthdate) : Matchers.notNullValue())
